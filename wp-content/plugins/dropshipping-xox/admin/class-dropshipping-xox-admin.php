...
class Dropshipping_Xox_Admin {
	...
	public function __construct( $plugin_name, $version ) {
		...
		$this->options = array('dropshix-opt', 'dropshix-search-product','dropshix-inactive-page','dropshix-report-page','dropshix-queued-page','dropshix-active-page');
	...
	public function enqueue_scripts() {
		...
		if(isset($_GET['page']) && in_array($_GET['page'], $this->options)){
			wp_enqueue_script( 'bootstrap', plugin_dir_url( __FILE__ ) . 'js/bootstrap/bootstrap.min.js', array( 'jquery' ), $this->version, true );
