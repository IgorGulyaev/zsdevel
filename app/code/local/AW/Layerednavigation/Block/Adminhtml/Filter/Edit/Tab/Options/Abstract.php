    ...
    implements Mage_Adminhtml_Block_Widget_Tab_Interface
{
    ...
    public function allowColorpicker()
    {
        return Mage::getModel('aw_layerednavigation/filter')->load('color','code')->getData('entity_id') == $this->getOptionList()->getFirstItem()->getData('filter_id');
    }
}