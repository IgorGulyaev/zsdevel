...
class Ecomitize_Scroll_Block_Catalog_Product_List extends Mage_Catalog_Block_Product_List
{
    ...
    public function getArrayCollections()
    {
        ...
        $rendererBlock = Mage::getBlockSingleton('ecomitize_all/product_renderer');
