    ...
    implements Mage_Widget_Block_Interface
{
    ...
    {
        $featuredProducts = $this->getLayout()->createBlock('zen_all/filterproducts_featured', 'featured_products')
            ->setTemplate('catalog/product/list/featured.phtml');

        $productRenderer = $this->getLayout()->createBlock('zen_all/product_renderer', 'product_renderer')->setImageType('image');
    ...
    {
        $salesProducts = $this->getLayout()->createBlock('zen_all/filterproducts_sale', 'on_sale_products')
            ->setTemplate('catalog/product/list/onsale.phtml');

        $productRenderer = $this->getLayout()->createBlock('zen_all/product_renderer', 'product_renderer');
    ...
    public function getBlock($name)
    {
        ...
        $mainBlock = $this->getLayout()->createBlock('zen_tab/dynamic', $name . '_products')
            ->setName($name);
