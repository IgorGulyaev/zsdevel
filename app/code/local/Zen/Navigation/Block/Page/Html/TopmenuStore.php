 ...
 */
class Zen_Navigation_Block_Page_Html_TopmenuStore extends Mage_Page_Block_Html_Topmenu
{
    ...
    public function __construct(array $args)
    {
        ...
        $this->_topMenuType = Mage::getStoreConfig('zen_all_options/topmenu/topmenu_type_option');
    }
    ...
    protected function _getHtml(Varien_Data_Tree_Node $menuTree, $childrenWrapClass, $isCategoryLink = true)
    {
        ...
        $_menuCategoryImageBasePath = Mage::getSingleton('zen_all/category_attribute_backend_image')->getMenuImageUrl();
    ...
    public function getTopmenuPosition(){
        $position = Mage::getStoreConfig('zen_all_options/topmenu/topmenu_position');
    ...
    public function getOffsetTop(){
        $offsetTop = Mage::getStoreConfig('zen_all_options/topmenu/topmenu_offset_top');
