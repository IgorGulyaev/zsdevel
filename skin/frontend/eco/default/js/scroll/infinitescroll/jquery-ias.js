...
(function($) {
    ...
    IAS.prototype.destroy = function() {
        for ( var i = 0; i < this.extensions.length; i++ ) {
            if ( this.extensions[i] instanceof IASTriggerExtension ) {
                this.extensions[i].destroyNext();
        ...
        promise.done(function() {
            self.load(url, function(data, items) {
                self.render(items, function() {
                    ...
                    jQuery(self.nextSelector).attr('href', self.nextUrl);
...
IASTriggerExtension.prototype.defaults = {
    text: 'Show More',
    html: '<div class="load-more"><button class="button btn-load-more ias-trigger ias-trigger-next">{text}</button></div>',
    textPrev: 'Load previous',
    htmlPrev: '<div class="load-more"><button class="button btn-load-more ias-trigger ias-trigger-prev">{text}</button></div>',
    offset: 0
};
